  ...
  const tariffs = [
    {
      ...
      speed: '100 Мбит/с',
      price: 1000,
      description: 'Для семьи из 2-3 человек. Идеален для соцсетей, видеозвонков и онлайн-фильмов',
    ...
    },
    {
      ...
      speed: '200 Мбит/с',
      price: 1200,
      description: 'Для большой семьи. Быстрый интернет + 150 ТВ-каналов в HD качестве',
    ...
    },
    {
      ...
      speed: '200 Мбит/с',
      price: 1500,
      description: 'Максимальный комфорт. Для тех, кто ценит премиальное качество связи и контента',
